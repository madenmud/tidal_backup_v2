...
const I18n = {
    ...
    strings: {
        ko: {
            ...
            help: '도움말',
            usageTitle: '사용법',
            usageSteps: '<strong>1단계</strong>: 왼쪽에서 백업할 계정(소스) 연결<br><strong>2단계</strong>: 오른쪽에서 복원할 계정(타겟) 연결<br><strong>3단계</strong>: 이전할 항목 선택 후 「이전 시작」 클릭<br><strong>대안</strong>: JSON 다운로드로 백업 → 나중에 JSON에서 복원',
            langKo: '한글',
            langEn: 'English',
            loginFailed: '로그인 실패',
        ...
        en: {
            ...
            help: 'Help',
            usageTitle: 'Usage',
            usageSteps: '<strong>Step 1</strong>: Connect source account (left panel) to copy FROM<br><strong>Step 2</strong>: Connect target account (right panel) to copy TO<br><strong>Step 3</strong>: Select items to transfer and click 「Start Transfer」<br><strong>Alternative</strong>: Download JSON to backup → Restore from JSON later',
            langKo: '한글',
            langEn: 'English',
