...
const I18n = {
    ...
    strings: {
        ko: {
            ...
            help: '?',
            usageTitle: '사용법',
            usageSteps: '<ol class="usage-steps"><li>왼쪽에서 백업할 계정(소스) 연결</li><li>오른쪽에서 복원할 계정(타겟) 연결</li><li>이전할 항목 선택 후 <strong>이전 시작</strong> 클릭</li><li><strong>대안</strong>: JSON 다운로드로 백업 → 나중에 JSON에서 복원</li></ol><p class="usage-note">⚠️ <strong>Spotify 주의</strong>: 기본 Client ID는 모든 사용자가 공유합니다. 속도 제한(429 에러)을 피하려면 <strong>개인 Client ID 등록</strong>을 권장합니다. Spotify 패널 하단의 "⚙️ Use Custom Client ID"를 참고하세요.</p>',
            langKo: '한글',
            langEn: 'English',
            loginFailed: '로그인 실패',
            ...
            noMatch: '매칭 실패',
            matchFound: '매칭 성공',
            spotifySettings: 'Spotify 설정',
            useCustomClient: '⚙️ 개인 Client ID 사용 (속도 제한 회피)',
            customClientId: '개인 Client ID',
            rateLimitWarning: '개인 ID를 사용하면 전송 속도 제한(429 Error)을 크게 줄일 수 있습니다.',
            setupGuide: 'Client ID 발급 방법:',
            guideStep1: '<a href="https://developer.spotify.com/dashboard" target="_blank">Spotify Developer Dashboard</a> 접속',
            guideStep2: '로그인 후 "Create App" 클릭',
            guideStep3: 'App Name에 아무 이름이나 입력 (예: My Transfer)',
            guideStep4: 'Settings에서 <strong>Redirect URI</strong>에 아래 주소 추가:',
            guideStep5: 'Dashboard의 <strong>Client ID</strong>를 복사하여 위에 붙여넣기',
            guideStep6: '저장 후 새로고침 클릭',
            settingSaved: '설정이 저장되었습니다. 새 ID로 다시 로그인해주세요.',
            cancel: '취소',
            saveReload: '저장 & 새로고침',
        },
        en: {
            ...
            help: '?',
            usageTitle: 'Usage',
            usageSteps: '<ol class="usage-steps"><li>Connect source account (left panel) to copy FROM</li><li>Connect target account (right panel) to copy TO</li><li>Select items to transfer and click <strong>Start Transfer</strong></li><li><strong>Alternative</strong>: Download JSON to backup → Restore from JSON later</li></ol><p class="usage-note">⚠️ <strong>Spotify Note</strong>: The default Client ID is shared by all users. To avoid rate limits (429 errors), we strongly recommend <strong>registering your own Client ID</strong>. See "⚙️ Use Custom Client ID" at the bottom of the Spotify panel.</p>',
            langKo: '한글',
            langEn: 'English',
            ...
            spotifySettings: 'Spotify Settings',
            useCustomClient: '⚙️ Use Custom Client ID (Avoid Rate Limits)',
            customClientId: 'Custom Client ID',
            rateLimitWarning: 'Using your own Client ID significantly reduces rate limits (429 Errors).',
            setupGuide: 'How to get a Client ID:',
            guideStep1: 'Go to <a href="https://developer.spotify.com/dashboard" target="_blank">Spotify Developer Dashboard</a>',
            guideStep2: 'Log in and click "Create App"',
            guideStep3: 'Enter any name (e.g., "My Transfer")',
            guideStep4: 'In Settings, add this <strong>Redirect URI</strong>:',
            guideStep5: 'Copy <strong>Client ID</strong> from dashboard and paste above',
            guideStep6: 'Click Save & Reload',
            settingSaved: 'Settings saved. Please log in again with new ID.',
            cancel: 'Cancel',
            saveReload: 'Save & Reload',
            apiHealthCheck: 'Checking API Health...',
            apiStatusGood: 'API Status: Good ✅',
            apiStatusBad: 'API Status: Rate Limited (429) ⚠️',
            apiStatusBadDesc: 'Using the default ID is limited. Please use a Custom Client ID.',
        }
    },
